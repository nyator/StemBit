  ...
  return (
    <SafeAreaView className="flex-1 justify-start items-center bg-primary">
      ...
      <View className="flex-1 justify-start items-center px-5 w-full">
        ...
        {/* <View className="flex justify-center items-center bg-[#ecf0f1] p-5">
          <Button
            title="Play Sound (C major)"
            onPress={() => {
              majorPadPlayers[0].seekTo(0);
              majorPadPlayers[0].play();
            }}
          />
          <Button
            title="Stop Sound (C major)"
            onPress={() => {
              majorPadPlayers[0].seekTo(0);
              majorPadPlayers[0].pause();
            }}
          />
        </View> */}
