...
// the right. The page indicator used to sit between them; it's now the
// segmented bar at the top of the screen instead (onboardingProgressBar.tsx),
// so this is just the two actions.
//
